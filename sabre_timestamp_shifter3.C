...
//   if(!compassFile->IsOpen()) std::cout << "\nFile open error!!";
   ...
   UShort_t Energy,Energy_corrected, EnergyShort;
   ULong64_t Timestamp;
   ...
   sabreShiftedTree->Branch("Energy",&Energy_corrected,"Energy_corrected/s");
