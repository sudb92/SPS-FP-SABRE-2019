{
   ...
   { 
      ...
      t[i]->Draw(("delayShortFL/delayLongFL:(delayTimeFL-delayTimeFR)/2>>"+nameL).c_str(),"delayTimeFL!=0 && delayTimeFR!=0 && abs(anodeTimeMB-anodeTimeMF)<200 && delayLongFL>0","col");
      t[i]->Draw(("delayShortFR/delayLongFR+0.1:(delayTimeFL-delayTimeFR)/2>>"+nameR).c_str(),"delayTimeFL!=0 && delayTimeFR!=0 && abs(anodeTimeMB-anodeTimeMF)<200 && delayLongBL>0","colSAME");
